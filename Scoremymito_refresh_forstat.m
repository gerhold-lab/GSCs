...
if A ~= 1
 ...
 % congression started before or after the start/end of image acquisition
           ...
           Germlineoutput(j).arrested = ((arrested)./(arrested+strongdelayed+notdelayed+delayed))*100;
           Germlineoutput(j).delayed = ((delayed)./(arrested+strongdelayed+notdelayed+delayed))*100;
           Germlineoutput(j).strongdelayed = ((strongdelayed)./(arrested+strongdelayed+notdelayed+delayed))*100;
           Germlineoutput(j).notdelayed = ((notdelayed)./(arrested+strongdelayed+notdelayed+delayed))*100;
    ...
    DurCongMin=DurCong2./60;
    end
clearvars -except Celloutput Germlineoutput Tiff_fileList Summary choice ennd DurCongMin
